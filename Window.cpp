...
void Window::draw() {
    ...
    //create all shapes
    sf::RectangleShape field(sf::Vector2f(modell->getSize().first * scalingFactor, modell->getSize().second * scalingFactor));
    ...
    paddleLeft.setPosition(FieldOffset.first, FieldOffset.second + scalingFactor * modell->getPaddleSize());
    ...
    paddleRight.setPosition(FieldOffset.first + field.getSize().x, FieldOffset.second + scalingFactor * modell->getPaddleSize());
    paddleRight.setOutlineThickness(5 * scalingFactor);

    sf::CircleShape ball(modell->getBallDiameter() * scalingFactor/2);
    ball.setOrigin(ball.getRadius(), ball.getRadius());
    ball.setFillColor(sf::Color::Yellow);
    ball.setPosition(FieldOffset.first + modell->getBallPos().first * scalingFactor, FieldOffset.second + modell->getBallPos().second * scalingFactor);
